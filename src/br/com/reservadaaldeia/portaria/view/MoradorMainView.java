...
public class MoradorMainView extends JFrame {
    ...
    private JPanel criarPainelVisitantes() {
        ...
        br.com.reservadaaldeia.portaria.dao.VisitanteDAO visDAO = new br.com.reservadaaldeia.portaria.dao.VisitanteDAO();
        
        Runnable carregarDados = () -> {
            model.setRowCount(0);
            try {
                List<br.com.reservadaaldeia.portaria.model.Visitante> visitantes = visDAO.listarPorMorador(moradorLogado.getId());
                for (br.com.reservadaaldeia.portaria.model.Visitante v : visitantes) {
                    String cpfExibicao = br.com.reservadaaldeia.portaria.util.ValidadorCPF.formatarEObscurecerCPF(v.getCpf(), "MORADOR");
