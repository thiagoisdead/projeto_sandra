package br.com.reservadaaldeia.portaria.view;

import br.com.reservadaaldeia.portaria.model.Usuario;
import br.com.reservadaaldeia.portaria.dao.UsuarioDAO;
import br.com.reservadaaldeia.portaria.model.Morador;
import br.com.reservadaaldeia.portaria.dao.MoradorDAO;
import br.com.reservadaaldeia.portaria.model.Apartamento;
import br.com.reservadaaldeia.portaria.dao.ApartamentoDAO;
import br.com.reservadaaldeia.portaria.model.Encomenda;
import br.com.reservadaaldeia.portaria.dao.EncomendaDAO;
import br.com.reservadaaldeia.portaria.model.Visitante;
import br.com.reservadaaldeia.portaria.dao.VisitanteDAO;
import br.com.reservadaaldeia.portaria.util.ValidadorCPF;
...
public class MainView extends JFrame {
    ...
    private JPanel criarPainelVisitantes() {
        ...
        btnEntrada.addActionListener(e -> {
            ...
            String papelVisitante = br.com.reservadaaldeia.portaria.database.DatabaseHelper.verificarPapelCpf(cpfVisitante);
    ...
    private JPanel criarPainelGerenciarUsuarios() {
        ...
        btnSalvar.addActionListener(e -> {
            ...
            String papel = br.com.reservadaaldeia.portaria.database.DatabaseHelper.verificarPapelCpf(cpf);
            if (papel != null) {
        ...
        btnEditar.addActionListener(e -> {
            ...
            try {
                ...
                if (option == JOptionPane.OK_OPTION) {
                    ...
                    String papel = br.com.reservadaaldeia.portaria.database.DatabaseHelper.verificarPapelCpf(nCpf);
