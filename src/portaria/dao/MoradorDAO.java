...
public class MoradorDAO {
    ...
    public void inserir(Morador morador) throws DAOException {
        ValidadorEntrada.validarNome(morador.getNome(), "Nome do Morador");
        if (morador.getLogin() != null && !morador.getLogin().trim().isEmpty()) {
            ValidadorEntrada.validarLogin(morador.getLogin());
        }
    ...
    public void atualizar(Morador m) throws DAOException {
        ValidadorEntrada.validarNome(m.getNome(), "Nome do Morador");
        if (m.getLogin() != null && !m.getLogin().trim().isEmpty()) {
            ValidadorEntrada.validarLogin(m.getLogin());
        }
