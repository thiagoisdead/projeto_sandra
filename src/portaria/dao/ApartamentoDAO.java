...
public class ApartamentoDAO {
    ...
    public int inserir(Apartamento apto) throws DAOException {
        ValidadorEntrada.validarApartamento(apto.getTorre(), apto.getBloco(), apto.getAndar(), apto.getNumero());
        ...
        try (Connection conn = DatabaseHelper.getConnection();
            ...
            if (e.getMessage() != null && e.getMessage().contains("UNIQUE constraint failed")) {
                throw new DAOException("Erro: Este apartamento já está cadastrado.", e);
            }
